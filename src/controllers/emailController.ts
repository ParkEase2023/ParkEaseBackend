...
export const sendEmailApproveRecipien = async (email: string) => {
    ...
    try {
        ...
        const mailOptions: nodemailer.SendMailOptions = {
            ...
            subject: 'ParkEase test send email',
            text:
                `Dear Parkease users, the bank account you have linked with the application has been approved at` +
                Date,
        };
...
export const sendEmailApproveTransfers = async (email: string, amount: number) => {
    ...
    try {
        ...
        const mailOptions: nodemailer.SendMailOptions = {
            ...
            subject: 'ParkEase test send email',
            text:
                `Dear Parkease users, You have withdrawn an amount ${amount} THB has been approved at` +
                Date,
        };
...
export const sendEmailmembership = async (email: string, type: string) => {
    const Date = getCurrentDateTime();
    try {
        const transporter = nodemailer.createTransport({
            host: 'smtp-relay.brevo.com',
        ...
        const mailOptions: nodemailer.SendMailOptions = {
            ...
            subject: 'ParkEase test send email',
            text:
                `Dear Parkease users, You have applied ${type} succeed at` + Date,
        };
...
export const sendEmailCancelmembership = async (email: string) => {
    const Date = getCurrentDateTime();
    try {
        const transporter = nodemailer.createTransport({
            host: 'smtp-relay.brevo.com',
        ...
        const mailOptions: nodemailer.SendMailOptions = {
            ...
            subject: 'ParkEase test send email',
            text:
                `Dear Parkease users, You have Cancel Membership  succeed at` + Date,
        };
...
export const sendEmaildestroymembership = async (email: string) => {
    const Date = getCurrentDateTime();
    try {
        const transporter = nodemailer.createTransport({
            host: 'smtp-relay.brevo.com',
        ...
        const mailOptions: nodemailer.SendMailOptions = {
            ...
            subject: 'ParkEase test send email',
            text:
                `Dear Parkease users, Your membership has ended at` + Date,
        };
